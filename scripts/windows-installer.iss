...
AppName=RazorTerminal
AppVersion={#AppVersion}
AppPublisher=RazorTerminal (mannaxsara)
AppPublisherURL=https://github.com/mannaxsara/razor-terminal
AppSupportURL=https://github.com/mannaxsara/razor-terminal/issues
AppUpdatesURL=https://github.com/mannaxsara/razor-terminal/releases
DefaultDirName={localappdata}\Programs\RazorTerminal
DefaultGroupName=RazorTerminal
...
OutputDir={#OutputDir}
OutputBaseFilename=RazorTerminalSetup
Compression=lzma2
...
[Icons]
Name: "{autoprograms}\RazorTerminal"; Filename: "{app}\bin\launcher.exe"; WorkingDir: "{app}\bin"; IconFilename: "{app}\Resources\gloomberb-logo.ico"
Name: "{autodesktop}\RazorTerminal"; Filename: "{app}\bin\launcher.exe"; WorkingDir: "{app}\bin"; IconFilename: "{app}\Resources\gloomberb-logo.ico"; Tasks: desktopicon

[Run]
Filename: "{app}\bin\launcher.exe"; Description: "Launch RazorTerminal"; Flags: nowait postinstall skipifsilent; WorkingDir: "{app}\bin"
