...
await buildPage("app", join(root, "src/renderers/browser/main.tsx"), "RazorTerminal", "Loading RazorTerminal...", "index.html");
await buildPage("share", join(root, "src/renderers/share/main.tsx"), "RazorTerminal Share", "Loading shared view...", "share.html");
