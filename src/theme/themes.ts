...
const rawThemes: Record<string, Theme> = {
  ...
  razorpay: {
    name: "Razorpay Blade Dark",
    description: "Official Razorpay Blade Dark theme with Electric Blue & Emerald accents",
    bg: "#070b14",
    panel: "#0e1626",
    border: "#1c2b48",
    borderFocused: "#3395ff",
    text: "#f8fafc",
    textDim: "#94a3b8",
    textBright: "#ffffff",
    textMuted: "#64748b",
...
export const DEFAULT_THEME = "razorpay";
